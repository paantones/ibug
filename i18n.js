...
en: {
  ...
  'admin.noAreas': 'No area set up yet. Create one in the area list first.',
...
de: {
  ...
  'admin.noAreas': 'Noch kein Bereich angelegt. Leg zuerst einen in der Bereichsliste an.',
...
tr: {
  ...
  'admin.noAreas': 'Henüz alan yok. Önce alan listesinde bir tane oluştur.',
...
ru: {
  ...
  'admin.noAreas': 'Зон пока нет. Сначала создайте зону в списке.',
...
uk: {
  ...
  'admin.noAreas': 'Зон поки немає. Спочатку створіть зону у списку.',
...
pl: {
  ...
  'admin.noAreas': 'Nie ma jeszcze żadnej strefy. Najpierw utwórz ją na liście stref.',
...
es: {
  ...
  'admin.noAreas': 'Todavía no hay ninguna zona. Créala primero en la lista de zonas.',
...
nl: {
  ...
  'admin.noAreas': 'Nog geen zone aangemaakt. Maak er eerst een aan in de zonelijst.',
...
ar: {
  ...
  'admin.release': 'تحرير',
  'admin.noAreas': 'لا توجد مناطق بعد. أنشئ منطقة أولاً في القائمة.',
...
it: {
  ...
  'admin.noAreas': 'Nessuna area ancora creata. Creane prima una nell’elenco.',
...
fr: {
  ...
  'admin.noAreas': 'Aucune zone créée pour l’instant. Créez-en une dans la liste.',
